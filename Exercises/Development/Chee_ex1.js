...
(function() {
    ...
    var chee_ex1 = {	// Name of export object
	userInput: null,  // Boolean: Tells us if user ever did anything

	// Initialise the exercise
	initJSAV: function(arr_size) {
	    chee_ex1.userInput = false;
	    av = new JSAV("Chee_ex1", {animationMode: "none"});
	...
	chee_ex1.userInput = true;
    }
    // Export name used here
    window.chee_ex1 = window.chee_ex1 || chee_ex1;
}());
