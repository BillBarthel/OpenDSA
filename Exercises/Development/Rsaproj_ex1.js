...
(function() {
    ...
    var rsaproj_ex1 = {	// Name of export object
	userInput: null,  // Boolean: Tells us if user ever did anything

	// Initialise the exercise
	initJSAV: function(arr_size) {
	    rsaproj_ex1.userInput = false;
	    av = new JSAV("Rsaproj_ex1", {animationMode: "none"});
	...
	rsaproj_ex1.userInput = true;
    }
    // Export name used here
    window.rsaproj_ex1 = window.rsaproj_ex1 || rsaproj_ex1;
}());
